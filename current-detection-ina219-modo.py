...
if __name__=='__main__':
    ...
    while True:
        ...
        shunt_voltage1 = ina1.getShuntVoltage_mV() / 1000 # voltage between V+ and V- acr>
        ...
        shunt_voltage2 = ina2.getShuntVoltage_mV() / 1000 # voltage between V+ and V- acr>
        ...
        shunt_voltage3 = ina3.getShuntVoltage_mV() / 1000 # voltage between V+ and V- acr>
        ...
        shunt_voltage4 = ina4.getShuntVoltage_mV() / 1000 # voltage between V+ and V- acr>
        ...
        print("ESC Current:{:6.3f}A    ".format((2.5 - (bus_voltage1 + shunt_voltage1))/0>
        print("PSU Voltage:{:6.3f}V    Shunt Voltage:{:9.6f}V    Load Voltage:{:6.3f}V   >
        print("PSU Voltage:{:6.3f}V    Shunt Voltage:{:9.6f}V    Load Voltage:{:6.3f}V   >
        print("PSU Voltage:{:6.3f}V    Shunt Voltage:{:9.6f}V    Load Voltage:{:6.3f}V   >
        print("PSU Voltage:{:6.3f}V    Shunt Voltage:{:9.6f}V    Load Voltage:{:6.3f}V   >
